...
description: Scan project dependencies across multiple ecosystems for vulnerabilities, SBOM generation, and supply chain security. Use PROACTIVELY when analyzing project dependencies, checking for vulnerable packages, or assessing supply chain risks.
model: inherit
---
