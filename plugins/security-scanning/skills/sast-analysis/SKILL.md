---
name: sast-analysis
description: Static Application Security Testing (SAST) for code vulnerability analysis across multiple languages and frameworks. Use when performing security code review, scanning for injection vulnerabilities, hardcoded secrets, or enforcing security policies.
---
