...
description: Data pipeline architecture expert for scalable batch and streaming data processing. Use PROACTIVELY when designing ETL/ELT pipelines, data ingestion, orchestration, or data quality frameworks.
model: inherit
---
