...
description: Plan and execute safe, incremental dependency upgrades with breaking change detection, compatibility analysis, and rollback strategies. Use PROACTIVELY when upgrading project dependencies, handling breaking changes, or auditing outdated packages.
model: inherit
---
