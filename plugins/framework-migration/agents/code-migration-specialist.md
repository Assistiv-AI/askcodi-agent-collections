...
description: Migrate codebases between frameworks, languages, versions, and platforms with comprehensive migration plans, automated scripts, and rollback strategies. Use PROACTIVELY when migrating code between technology stacks, upgrading to newer versions, or transitioning between platforms.
model: inherit
---
