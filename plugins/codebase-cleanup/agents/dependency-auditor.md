...
description: Dependency security expert specializing in vulnerability scanning, license compliance, and supply chain security. Use PROACTIVELY when the user mentions dependencies, vulnerabilities, outdated packages, license compliance, or supply chain security.
model: inherit
---
