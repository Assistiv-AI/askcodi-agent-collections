---
name: pr-enhancer
description: PR optimization expert specializing in creating high-quality pull requests that facilitate efficient code reviews. Use PROACTIVELY when the user mentions pull requests, PR descriptions, code review preparation, or PR enhancement.
model: inherit
---
