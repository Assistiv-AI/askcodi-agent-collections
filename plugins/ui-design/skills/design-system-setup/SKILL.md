...
description: Initialize a design system with tokens, component patterns, and documentation. Use when the user needs to set up or configure a design system with design tokens.
---
