...
description: Audit UI code for WCAG compliance with actionable remediation guidance. Use when the user needs to check accessibility, WCAG compliance, or a11y issues in their UI components.
---
