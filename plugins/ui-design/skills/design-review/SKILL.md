---
name: design-review
description: Review existing UI for design issues, usability problems, and improvement opportunities. Use when the user wants feedback on UI code quality, visual design, or usability.
---
