...
description: Optimize prompts for production with CoT, few-shot, and constitutional AI patterns. Use when crafting effective LLM prompts, improving prompt accuracy, reducing hallucinations, or optimizing token efficiency.
---
