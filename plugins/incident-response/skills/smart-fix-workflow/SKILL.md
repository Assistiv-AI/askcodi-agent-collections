---
name: smart-fix-workflow
description: Intelligent issue resolution with multi-agent debugging, root cause analysis, and verified fix implementation. Use when resolving complex issues that need systematic debugging, root cause analysis, and verified fixes with prevention strategies.
---
