...
description: Create detailed 3-5 year financial model with revenue, costs, cash flow, and scenarios. Use when the user needs startup financial projections, revenue modeling, or fundraising financial plans.
---
...
This skill builds a complete financial model including:
