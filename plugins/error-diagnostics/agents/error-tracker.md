---
name: error-tracker
description: Error tracking and observability expert for comprehensive error monitoring solutions. Use PROACTIVELY when setting up error tracking, configuring alerts, implementing structured logging, or resolving production monitoring issues.
model: inherit
---
