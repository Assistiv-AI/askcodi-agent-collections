---
name: seo-geo
description: Optimize content for AI Overviews, ChatGPT web search, Perplexity, and other AI-powered search experiences. Generative Engine Optimization (GEO) analysis. Use when user says "AI Overviews", "SGE", "GEO", "AI search", "LLM optimization", "Perplexity", "AI citations", "ChatGPT search", or "AI visibility".
---
...
- User asks about AI search visibility or GEO optimization
- User says "AI Overviews", "SGE", "GEO", "AI search", "LLM optimization", "Perplexity", "AI citations", "ChatGPT search", or "AI visibility"
- Need to optimize content for AI citation and AI Overview inclusion
- Assessing AI crawler access and llms.txt compliance
