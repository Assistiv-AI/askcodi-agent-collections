...
- User asks about backlinks, link profile, or internal linking
- User says "backlinks", "link profile", "internal links", "broken links", "link equity", "referring domains", or "link building"
- Need to audit internal link structure or broken links
- Analyzing external backlink profile via CommonCrawl
...
See `references/link-building.md` for PageRank flow guidance.
...
Reference `references/link-building.md` for:
