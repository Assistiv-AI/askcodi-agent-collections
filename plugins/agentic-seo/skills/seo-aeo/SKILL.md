...
- User asks about Featured Snippets, People Also Ask, or Knowledge Panel
- User says "featured snippet", "people also ask", "knowledge panel", "answer box", "zero-click", or "AEO"
- Need to optimize for zero-click rich results
- Auditing entity presence for Knowledge Graph
