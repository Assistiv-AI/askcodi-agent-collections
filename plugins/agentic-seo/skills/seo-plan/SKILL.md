...
- User asks for an SEO strategy or planning
- User says "SEO plan", "SEO strategy", "content strategy", "site architecture", or "SEO roadmap"
- Need to create implementation roadmap or competitive analysis
- Planning content clusters and topical authority
...
- Load industry template from `assets/`
