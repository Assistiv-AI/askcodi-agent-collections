---
name: seo-technical
description: Technical SEO audit across 8 categories — crawlability, indexability, security, URL structure, mobile, Core Web Vitals, structured data, and JavaScript rendering. Use when user says "technical SEO", "crawl issues", "robots.txt", "Core Web Vitals", "site speed", or "security headers".
---
...
- Need to assess crawlability, indexability, or security posture
- Checking JavaScript rendering or mobile optimization
