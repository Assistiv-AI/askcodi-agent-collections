...
- User asks about image optimization or alt text
- User says "image optimization", "alt text", "image SEO", "image size", or "image audit"
- Need to audit image formats, sizes, and accessibility
- Checking CLS prevention via image dimensions
