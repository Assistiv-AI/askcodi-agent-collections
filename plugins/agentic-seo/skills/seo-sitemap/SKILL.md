...
- User asks about sitemap creation or validation
- User says "sitemap", "generate sitemap", "sitemap issues", or "XML sitemap"
- Need to validate XML sitemap format and coverage
- Generating a new sitemap for site architecture
...
2. Load industry template from `templates/`
