...
- User asks about GitHub repository SEO or discoverability
- User says "GitHub SEO", "optimize this repo", "README SEO", "topics optimization", or "community profile audit"
- Need to improve repository search visibility
- Auditing GitHub repository metadata and README quality

Apply `references/llm-audit-rubric.md` for evidence format and
confidence labels, and apply `references/readme-audit-rubric.md`
for README scoring.
...
- Strategy synthesis: `agents/seo-github-analyst.md`
- Competitor/query benchmark: `agents/seo-github-benchmark.md`
- API collection/archival: `agents/seo-github-data.md`
- Final verification: `agents/seo-verifier.md`
