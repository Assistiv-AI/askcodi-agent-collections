...
- Need to validate existing JSON-LD implementation
- Generating schema for a new page type
...
3. Validate each schema object against rules in `references/schema-types.md`.
