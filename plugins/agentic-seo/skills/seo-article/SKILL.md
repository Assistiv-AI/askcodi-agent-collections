...
- User asks about article or blog post SEO optimization
- User says "article SEO", "optimize this blog post", "rewrite meta/title", or "content optimization for a post"
- Need keyword extraction, content-gap analysis, or title/meta rewrites
- Performing paragraph-level content improvement
