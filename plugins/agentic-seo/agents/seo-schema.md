---
name: seo-schema
description: Schema markup expert. Detects, validates, and generates Schema.org structured data in JSON-LD format. Use PROACTIVELY when analyzing structured data, rich results eligibility, JSON-LD validation, or schema generation.
model: inherit
---
