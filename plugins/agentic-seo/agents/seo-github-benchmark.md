...
description: GitHub search benchmark specialist. Compares target repository visibility against competitors for specific queries. Use PROACTIVELY when benchmarking GitHub search positions, analyzing competitor repos, or tracking query visibility.
model: inherit
---
