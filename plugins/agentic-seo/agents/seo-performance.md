...
description: Performance analyzer. Measures and evaluates Core Web Vitals and page load performance. Use PROACTIVELY when analyzing page speed, LCP/INP/CLS metrics, or performance optimization opportunities.
model: inherit
---
...
| **CrUX Vis** (Nov 2025) | Replaced CrUX Dashboard. Use cruxvis.withgoogle.com or CrUX API |
