---
name: seo-visual
description: Visual analyzer. Captures screenshots, tests mobile rendering, and analyzes above-the-fold content using Playwright. Use PROACTIVELY when analyzing page layout, mobile responsiveness, screenshot comparison, or SSR vs CSR rendering.
model: inherit
---
