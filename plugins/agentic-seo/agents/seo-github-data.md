...
description: GitHub API data collector and archival specialist for repository SEO telemetry. Use PROACTIVELY when collecting GitHub API data, archiving traffic snapshots, or validating token access for repo analytics.
model: inherit
---
