---
name: seo-sitemap
description: Sitemap architect. Validates XML sitemaps, generates new ones with industry templates, and enforces quality gates for location pages. Use PROACTIVELY when analyzing sitemap structure, generating sitemaps, or checking location page thresholds.
model: inherit
---
