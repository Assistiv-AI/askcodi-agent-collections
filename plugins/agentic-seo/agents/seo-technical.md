---
name: seo-technical
description: Technical SEO specialist. Analyzes crawlability, indexability, security, URL structure, mobile optimization, Core Web Vitals, and JavaScript rendering. Use PROACTIVELY when analyzing website infrastructure, robots.txt, security headers, redirect chains, or JS rendering issues.
model: inherit
---
