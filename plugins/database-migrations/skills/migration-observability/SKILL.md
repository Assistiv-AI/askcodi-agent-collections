...
description: Migration monitoring, CDC, and observability infrastructure. Use when setting up Change Data Capture pipelines, real-time migration monitoring, anomaly detection, or automated alerting for database migrations.
---
