...
description: Implement minimal code to make failing tests pass in TDD green phase. Use when the user needs to write production code to satisfy failing TDD tests.
---
