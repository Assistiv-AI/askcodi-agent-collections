---
name: tdd-red-phase
description: Write comprehensive failing tests following TDD red phase principles. Use when the user needs to create failing tests for a feature or component as part of TDD.
---
