...
description: Refactor code with confidence using comprehensive test safety net. Use when the user needs to improve code quality while keeping all TDD tests green.
---
