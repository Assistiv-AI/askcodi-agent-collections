---
name: track-creation
description: Create a new track with specification and phased implementation plan. Use when the user wants to create a new feature, bug, chore, or refactor track.
---
