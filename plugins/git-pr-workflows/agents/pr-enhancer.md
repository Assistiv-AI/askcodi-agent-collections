---
name: pr-enhancer
description: Optimize pull requests with comprehensive descriptions, automated review checklists, risk assessment, and test coverage analysis for efficient code reviews. Use PROACTIVELY when creating pull requests, improving PR descriptions, or facilitating code review processes.
model: inherit
---
...
def generate_change_list(analysis):
    ...
    for category, files in changes_by_category.items():
        change_list += f"\n### {icons.get(category, 'Other')} {category.title()} Changes\n"
